	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (!String::IsNullOrEmpty(textBox1->Text)) {
			if (!Double::TryParse(textBox1->Text, a)) {
				System::Windows::Forms::MessageBox::Show("Введите числовое значение для коэффициента A");
				return;
			}
		}
		...
		if (!String::IsNullOrEmpty(textBox2->Text)) {
			if (!Double::TryParse(textBox2->Text, b)) {
				System::Windows::Forms::MessageBox::Show("Введите числовое значение для коэффициента B");
				return;
			}
		}
		...
		if (!String::IsNullOrEmpty(textBox3->Text)) {
			if (!Double::TryParse(textBox3->Text, c)) {
				System::Windows::Forms::MessageBox::Show("Введите числовое значение для коэффициента C");
				return;
			}
		}

		if (equationType == -1) {
			System::Windows::Forms::MessageBox::Show("Выберите тип уравнения");
			return;
		}
